...
```go reference
https://github.com/josh-wong/go-chatgpt/blob/df291cd0fcec1b7b6b203de73246aac10c4912f6/chat.go#L14-L22
```
...
```go reference
https://github.com/josh-wong/go-chatgpt/blob/df291cd0fcec1b7b6b203de73246aac10c4912f6/chat.go#L149-L151
```

## Testing and validating the new models

After making these changes, I installed the new version, [v0.4.1](https://github.com/josh-wong/go-chatgpt/releases/tag/v0.4.1), in my local environment. Since I'll be using my version of the Go-ChatGPT client moving forward, I needed to update the Go files in my chatbot application to refer to my repository and version.
